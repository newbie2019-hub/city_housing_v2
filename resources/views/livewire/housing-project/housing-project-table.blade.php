<div class="mt-5">
                        ...
                        <td class="px-6 py-4 text-center ">
                            <div class="flex justify-between ">
                                ...
                                <div
                                    ...
                                    <button type="submit"
                                        wire:click='$emit("openModal", "confirm-delete-modal" , {{ json_encode([$housing->id, "Housing Project" , "delete"]) }})'>
                                        Move to Trash
                                    </button>
                                </div>
                            </div>
    ...
    <div class="my-6 text-2xl font-semibold text-gray-700 mt-14">
        <p class="text-2xl leading-8">
            Archive Housing Project
        </p>
        <p class="text-base font-normal">Here are the archived housing project of this system.</p>
        </p>
    </div>
    <div class="container overflow-x-auto  mt-5">
        <div class="w-full shadow-sm sm:rounded-lg">
            <table class="[&>*]:p-4 w-full text-sm text-left text-gray-500 table-auto dark:text-gray-400">
                ...
                <tbody>
                    @forelse ($archivedHousings as $archivedhousing)
                    <tr class="text-gray-900 bg-white border-b dark:bg-gray-800 dark:border-gray-700 dark:text-white">
                        <td class="px-6 py-4">
                            {{ $archivedhousing->id }}
                        </td>
                        ...
                        <td class="px-6 py-4">
                            {{ $archivedhousing->project }}
                        </td>

                        <td class="px-6 py-4">
                            {{ $archivedhousing->location }}
                        </td>

                        <td class="px-6 py-4">
                            {{ $archivedhousing->description }}
                        </td>
                        ...
                        <td class="px-6 py-4 text-center ">
                            <div class="flex justify-between ">
                                ...
                                <div class="w-full font-medium transform hover:text-purple-500 hover:scale-110 ">
                                    ...
                                    <button wire:click='$emit("openModal", "housing-project.edit-modal" , {{
                                     json_encode(["housingproject" => $archivedhousing->id]) }})'>
                                        Edit
                                    </button>
                                </div>
                                ...
                                <div
                                    class="w-full font-medium text-red-600 transform hover:text-red-900 hover:scale-110">
                                    <button type="submit"
                                        wire:click='$emit("openModal", "confirm-delete-modal" , {{ json_encode([$archivedhousing->id, "Housing Project" , "restore"]) }})'>
                                        Restore
                                    </button>
                                </div>
                            </div>
