    ...
    <div class="w-9/12 ">
        <div class="overflow-auto bg-white shadow-sm w-96 sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form wire:submit.prevent="updateHousingUnitStatus">
                    <div class="mb-5">
                        <p class="text-xl font-medium text-left">Update Housing Unit Status</p>
                    ...
                    <div>
                        ...
                        <div class="mt-4">
                            <div class="relative">
                                <x-floating-input type="text" id="status" name="status" wire:model.defer="status"
                    ...
                    <div class="flex justify-end mt-5">
                        ...
                        <x-button.text-button btnType="success" type="submit">Update Housing
                            Unit
                        </x-button.text-button>
                    </div>
                </form>
