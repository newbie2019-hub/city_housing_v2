<div class="mt-20">
                    ...
                    <x-slot name="body">
                        ...
                        <x-table.row wire:loading.class="opacity-50" striped>
                            <x-table.cell class="cell">
                                <input type="checkbox" value="{{ $housingunit->id }}" wire:model="checked">
                            </x-table.cell>
                            <x-table.cell class="cell">
                                {{ $housingunit->id }}
                            </x-table.cell>
                                ...
                                <div class="flex gap-3 ">
                                    ...
                                    <div class="w-full font-medium transform hover:text-purple-500 hover:scale-110 ">
                                        ...
                                        <button wire:click='$emit("openModal", "housing-unit.edit-modal" , {{
                                         json_encode(["housingunit" => $housingunit->id]) }})'>
                                            Edit
                                        </button>
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <button type="submit"
                                            wire:click='$emit("openModal", "confirm-delete-modal" , {{ json_encode([$housingunit->id, "Housing Unit" , "delete"]) }})'>
                                            Move to Trash
                                        </button>
                                    </div>
                                </div>
    ...
    <div class="mt-4 bg-white rounded-lg shadow-xs">
        <div class="my-6 text-2xl font-semibold text-gray-700 mt-14">
            <p class="text-2xl leading-8">
                Archived Housing Unit
            </p>
            <p class="text-base font-normal">Here are the housing unit that is archived in the system</p>
            </p>
        </div>
        ...
        <div class="mt-16 mb-5">
            <div class="container overflow-x-auto">
                <x-table>
                    ...
                    <x-slot name="body">
                        @forelse ($archivedHousingunits as $archivedHousingunit)
                        <x-table.row wire:loading.class="opacity-50" striped>
                            <x-table.cell class="cell">
                                <input type="checkbox" value="{{ $archivedHousingunit->id }}" wire:model="checked">
                            </x-table.cell>
                            <x-table.cell class="cell">
                                {{ $archivedHousingunit->id }}
                            </x-table.cell>
                            <x-table.cell class="cell">
                                {{ $archivedHousingunit->housingproject->project }}
                            </x-table.cell>
                            <x-table.cell class="cell">
                                {{ $archivedHousingunit->phase_no }}
                            </x-table.cell>
                            <x-table.cell class="cell">
                                {{ $archivedHousingunit->block_no }}
                            </x-table.cell>
                            <x-table.cell class="cell">
                                {{ $archivedHousingunit->lot_no }}
                            </x-table.cell>
                            <x-table.cell class="cell">
                                {{ $archivedHousingunit->remark }}
                            </x-table.cell>
                                ...
                                <div class="flex gap-3 ">
                                    <div
                                        ...
                                        <button wire:click='$emit("openModal", "user-detail-modal" , {{
                                         json_encode(["user" => $archivedHousingunit->id]) }})'>
                                            View Detail
                                        </button>
                                    </div>
                                    <div class="w-full font-medium transform hover:text-purple-500 hover:scale-110 ">
                                    ...
                                    <div
                                        class="w-full font-medium text-red-600 transform hover:text-red-900 hover:scale-110">
                                        <button type="submit"
                                            wire:click='$emit("openModal", "confirm-delete-modal" , {{ json_encode([$archivedHousingunit->id, "Housing Unit" , "restore"]) }})'>
                                            Move to Trash
                                        </button>
                                    </div>
                                </div>
                ...
                <div class="mt-5 mb-5">
                    {{ $archivedHousingunits->onEachSide(0)->links() }}
                </div>
            </div>
