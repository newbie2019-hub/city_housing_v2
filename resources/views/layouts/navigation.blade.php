    ...
    <div class="py-4">
        <div>
            ...
            <ul class=" mt-4">
                ...
                <li class="relative px-6 py-2">
                    <x-nav-link class="{{ request()->routeIs('occupancy.*') ? 'text-[#5283F1]' : 'text-[#525252]' }}"
                        href="{{ route('occupancy') }}" :active="request()->routeIs('occupancy.*')">
                        ...
                        <span class="">{{ __('Occupancy Status') }}</span>
                    </x-nav-link>
                </li>
