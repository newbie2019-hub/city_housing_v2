<x-app-layout>
    ...
    <div class="mt-5">
        ...
        <div class="grid grid-cols-3 gap-2">
            ...
            <div class="mt-4">
                <div class="relative">
                    <x-floating-input type="text" id="contact" name="contact" value="{{ $applicant->info->contact }}"
                        class="block w-full " />
            ...
            <div class="mt-4">
                <div class="relative">
                    <x-floating-input type="text" id="govt_id" name="govt_id" value="{{ $applicant->info->govt_id }}"
                        class="block w-full " />
            ...
            <div class="grid grid-cols-3 gap-6 ">
                ...
                <div class="mt-4">
                    ...
                    <select id="familyCompositions[{{ $index }}][gender]"
                        name="familyCompositions[{{ $index }}][gender]" class="'block p-3 w-full text-sm
                    text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600
                    dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                        <option value="" selected>
                            Select a Gender
