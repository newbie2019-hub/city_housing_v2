...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'housingunit_create']);
        Permission::create(['name' => 'housingunit_update']);
        Permission::create(['name' => 'housingunit_delete']);
        Permission::create(['name' => 'housingunit_access']);
